...
def get_estamated_interations_and_time(log_info: bool = False) -> int:
    """calculate estimated iterations and time to take based on
    the script config

    Args:
        log_info (bool, optional): whether to print out the estimnated number
        defaults to False.
    ...
    if log_info:
        ...
        # logger.info(
        #     '{} sec / per iteration'.format(float(SEC_TO_SLEEP_AFTER_INCREASING_PARAM))
        # )
